...
- (void)simplePing:(SimplePing *)pinger didReceivePingResponsePacket:(NSData *)packet sequenceNumber:(uint16_t)sequenceNumber address:(NSData *)address;
...
- (void)simplePing:(SimplePing *)pinger didReceiveUnexpectedPacket:(NSData *)packet address:(NSData *)address;
